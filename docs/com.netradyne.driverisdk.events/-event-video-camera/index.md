//[Netradyne Driveri SDK](../../index.md)/[com.netradyne.driverisdk.events](../index.md)/[EventVideoCamera](index.md)



# EventVideoCamera  
 [common] class [EventVideoCamera](index.md)

Different cameras supported by Driveri
...
|  Name|  Summary| 
|---|---|
| <a name="com.netradyne.driverisdk.events/EventVideoCamera/EventVideoCamera/#/PointingToDeclaration/"></a>[EventVideoCamera](-event-video-camera.md)| <a name="com.netradyne.driverisdk.events/EventVideoCamera/EventVideoCamera/#/PointingToDeclaration/"></a> [common] fun [EventVideoCamera](-event-video-camera.md)()   <br>
...
|  Name|  Summary| 
|---|---|
| <a name="com.netradyne.driverisdk.events/EventVideoCamera.Companion///PointingToDeclaration/"></a>[Companion](-companion/index.md)| <a name="com.netradyne.driverisdk.events/EventVideoCamera.Companion///PointingToDeclaration/"></a>[common]  <br>Content  <br>object [Companion](-companion/index.md)  <br><br><br>
