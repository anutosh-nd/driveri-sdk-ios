...
@class DriverisdkNDAPIClient, DriverisdkNDAuthAPI, DriverisdkNDError, DriverisdkNDCoachingAPI, DriverisdkEither<__covariant L, __covariant R>, DriverisdkNDEventAccessAPI, DriverisdkNDEventsAPI, DriverisdkNDGreenzoneAPI, DriverisdkNDUserAPI, DriverisdkNDVideoAPI, DriverisdkEitherLeft<__covariant L>, DriverisdkKotlinNothing, DriverisdkEitherRight<__covariant R>, DriverisdkDriverScoreWithRank, DriverisdkDrivingStats, DriverisdkHighImpactEvent, DriverisdkNDStatsInterval, DriverisdkNDLeaderboard, DriverisdkNDGreenzoneStats, DriverisdkAlertDistribution, DriverisdkEventDateFilter, DriverisdkLatLong, DriverisdkNDEvent, DriverisdkNDEventComment, DriverisdkNDEventData, DriverisdkNDVideo, DriverisdkNDEventDetail, DriverisdkNDAPIResponse, DriverisdkNDWeeklyReviewSession, DriverisdkNDWeeklyReviewSessionDetail, DriverisdkNDCommentNotification, DriverisdkNDDriverReportNotification, DriverisdkNDEventAccessNotification, DriverisdkNDEventNotification, DriverisdkNDFeedbackSharedNotification, DriverisdkNDNotificationMessage, DriverisdkNDTrimmedVideoNotification, DriverisdkNDWeeklyReviewNotification, DriverisdkNDNotifications, DriverisdkNDEventAccessRequest, DriverisdkNDVideoData, DriverisdkNDEventFeedback, DriverisdkNDFeedbackCategory, DriverisdkNDFeedbackConversation, DriverisdkNDFeedbackState, DriverisdkNDUser, DriverisdkNDVODConsumption, DriverisdkPasswordResponse, DriverisdkKotlinArray<T>, DriverisdkKotlinx_serialization_coreSerializersModule, DriverisdkKotlinx_serialization_coreSerialKind, DriverisdkKotlinx_serialization_coreUpdateMode, DriverisdkKotlinEnum<E>;

@protocol DriverisdkKotlinx_serialization_coreKSerializer, DriverisdkNDApi, DriverisdkKotlinx_serialization_coreEncoder, DriverisdkKotlinx_serialization_coreSerialDescriptor, DriverisdkKotlinx_serialization_coreSerializationStrategy, DriverisdkKotlinx_serialization_coreDecoder, DriverisdkKotlinx_serialization_coreDeserializationStrategy, DriverisdkKotlinx_serialization_coreCompositeEncoder, DriverisdkKotlinAnnotation, DriverisdkKotlinx_serialization_coreCompositeDecoder, DriverisdkKotlinIterator, DriverisdkKotlinx_serialization_coreSerializersModuleCollector, DriverisdkKotlinKClass, DriverisdkKotlinComparable, DriverisdkKotlinKDeclarationContainer, DriverisdkKotlinKAnnotatedElement, DriverisdkKotlinKClassifier;
...
__attribute__((swift_name("NDApi")))
@protocol DriverisdkNDApi
@required
...
@interface DriverisdkPlatform : DriverisdkBase
...
@interface DriverisdkNDGreenzoneAPI : DriverisdkBase <DriverisdkNDApi>
- (void)destroy __attribute__((swift_name("destroy()")));
...
- (instancetype)initWithNumDrivers:(int32_t)numDrivers leaderboard:(NSArray<DriverisdkDriverScoreWithRank *> * _Nullable)leaderboard gamificationFlag:(BOOL)gamificationFlag __attribute__((swift_name("init(numDrivers:leaderboard:gamificationFlag:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component1 __attribute__((swift_name("component1()")));
- (NSArray<DriverisdkDriverScoreWithRank *> * _Nullable)component2 __attribute__((swift_name("component2()")));
- (DriverisdkNDLeaderboard *)doCopyNumDrivers:(int32_t)numDrivers leaderboard:(NSArray<DriverisdkDriverScoreWithRank *> * _Nullable)leaderboard gamificationFlag:(BOOL)gamificationFlag __attribute__((swift_name("doCopy(numDrivers:leaderboard:gamificationFlag:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)toJSONString __attribute__((swift_name("toJSONString()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<DriverisdkDriverScoreWithRank *> * _Nullable leaderboard __attribute__((swift_name("leaderboard")));
@property (readonly) int32_t numDrivers __attribute__((swift_name("numDrivers")));
@end;
...
@interface DriverisdkNDAuthAPI : DriverisdkBase <DriverisdkNDApi>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AlertDistribution")))
@interface DriverisdkAlertDistribution : DriverisdkBase
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("AlertDistribution.Companion")))
@interface DriverisdkAlertDistributionCompanion : DriverisdkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<DriverisdkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
- (NSString *)toJSONString __attribute__((swift_name("toJSONString()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<DriverisdkAlertDistribution *> *alertDistribution __attribute__((swift_name("alertDistribution")));
...
@interface DriverisdkNDEventsAPI : DriverisdkBase <DriverisdkNDApi>
...
@interface DriverisdkNDCoachingAPI : DriverisdkBase <DriverisdkNDApi>
- (void)destroy __attribute__((swift_name("destroy()")));
...
- (instancetype)initWithSessionId:(NSString *)sessionId description:(NSString *)description createdAt:(int64_t)createdAt driverId:(int32_t)driverId driverName:(NSString * _Nullable)driverName sessionStartTime:(int64_t)sessionStartTime sessionEndTime:(int64_t)sessionEndTime driverStarsCount:(int32_t)driverStarsCount subTenantId:(int32_t)subTenantId tenantId:(int32_t)tenantId eventIds:(NSArray<DriverisdkLong *> * _Nullable)eventIds eventType:(int32_t)eventType driverStarIds:(NSArray<DriverisdkLong *> * _Nullable)driverStarIds greenzoneVersion:(NSString * _Nullable)greenzoneVersion sessionAge:(DriverisdkInt * _Nullable)sessionAge vcStatus:(int32_t)vcStatus __attribute__((swift_name("init(sessionId:description:createdAt:driverId:driverName:sessionStartTime:sessionEndTime:driverStarsCount:subTenantId:tenantId:eventIds:eventType:driverStarIds:greenzoneVersion:sessionAge:vcStatus:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
...
- (int32_t)component8 __attribute__((swift_name("component8()")));
- (DriverisdkNDWeeklyReviewSession *)doCopySessionId:(NSString *)sessionId description:(NSString *)description createdAt:(int64_t)createdAt driverId:(int32_t)driverId driverName:(NSString * _Nullable)driverName sessionStartTime:(int64_t)sessionStartTime sessionEndTime:(int64_t)sessionEndTime driverStarsCount:(int32_t)driverStarsCount subTenantId:(int32_t)subTenantId tenantId:(int32_t)tenantId eventIds:(NSArray<DriverisdkLong *> * _Nullable)eventIds eventType:(int32_t)eventType driverStarIds:(NSArray<DriverisdkLong *> * _Nullable)driverStarIds greenzoneVersion:(NSString * _Nullable)greenzoneVersion sessionAge:(DriverisdkInt * _Nullable)sessionAge vcStatus:(int32_t)vcStatus __attribute__((swift_name("doCopy(sessionId:description:createdAt:driverId:driverName:sessionStartTime:sessionEndTime:driverStarsCount:subTenantId:tenantId:eventIds:eventType:driverStarIds:greenzoneVersion:sessionAge:vcStatus:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly, getter=description_) NSString *description __attribute__((swift_name("description")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("VCSessionDetailSerializer")))
@interface DriverisdkVCSessionDetailSerializer : DriverisdkBase <DriverisdkKotlinx_serialization_coreKSerializer>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)vCSessionDetailSerializer __attribute__((swift_name("init()")));
- (DriverisdkNDWeeklyReviewSessionDetail *)deserializeDecoder:(id<DriverisdkKotlinx_serialization_coreDecoder>)decoder __attribute__((swift_name("deserialize(decoder:)")));
- (void)serializeEncoder:(id<DriverisdkKotlinx_serialization_coreEncoder>)encoder value:(DriverisdkNDWeeklyReviewSessionDetail *)value __attribute__((swift_name("serialize(encoder:value:)")));
@property (readonly) id<DriverisdkKotlinx_serialization_coreSerialDescriptor> descriptor __attribute__((swift_name("descriptor")));
@end;
...
@interface DriverisdkNDVideoAPI : DriverisdkBase <DriverisdkNDApi>
- (void)destroy __attribute__((swift_name("destroy()")));
...
@property (readonly) DriverisdkNDDriverReportNotification * _Nullable driverReportNotification __attribute__((swift_name("driverReportNotification")));
...
@property (readonly) int64_t timestamp __attribute__((swift_name("timestamp")));
@property (readonly) DriverisdkNDTrimmedVideoNotification * _Nullable trimmedVideoNotification __attribute__((swift_name("trimmedVideoNotification")));
...
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)destroy __attribute__((swift_name("destroy()")));
- (void)doInitNotifications __attribute__((swift_name("doInitNotifications()")));
@end;
...
@interface DriverisdkNDEventAccessAPI : DriverisdkBase <DriverisdkNDApi>
...
- (instancetype)initWithFeedbackId:(NSString *)feedbackId eventId:(int32_t)eventId message:(NSString *)message categoryId:(int32_t)categoryId image:(NSString *)image __attribute__((swift_name("init(feedbackId:eventId:message:categoryId:image:)"))) __attribute__((objc_designated_initializer));
- (int32_t)component2 __attribute__((swift_name("component2()")));
- (NSString *)component3 __attribute__((swift_name("component3()")));
- (int32_t)component4 __attribute__((swift_name("component4()")));
- (NSString *)component5 __attribute__((swift_name("component5()")));
- (DriverisdkNDEventFeedback *)doCopyFeedbackId:(NSString *)feedbackId eventId:(int32_t)eventId message:(NSString *)message categoryId:(int32_t)categoryId image:(NSString *)image __attribute__((swift_name("doCopy(feedbackId:eventId:message:categoryId:image:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface DriverisdkNDUserAPI : DriverisdkBase <DriverisdkNDApi>
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasswordResponse")))
@interface DriverisdkPasswordResponse : DriverisdkBase
- (instancetype)initWithResponse:(BOOL)response data:(NSString * _Nullable)data __attribute__((swift_name("init(response:data:)"))) __attribute__((objc_designated_initializer));
- (BOOL)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (DriverisdkPasswordResponse *)doCopyResponse:(BOOL)response data:(NSString * _Nullable)data __attribute__((swift_name("doCopy(response:data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasswordResponse.Companion")))
@interface DriverisdkPasswordResponseCompanion : DriverisdkBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<DriverisdkKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
